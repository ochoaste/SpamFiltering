...
def main():
    ...
    list_of_test_files_s = labels['spam'][test_start:-1]
    random.shuffle(list_of_test_files_s)
    list_of_test_files_h = labels['ham'][test_start:-1]
    random.shuffle(list_of_test_files_h)

    list_of_test_files = list_of_test_files_s[:test_range]+ list_of_test_files_h[:test_range]
